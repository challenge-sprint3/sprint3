...
export default function Integrantes() {
  return (
    <div className="relative min-h-screen font-sans">
      ...
      <footer
        className="z-10 flex justify-center gap-16 items-center h-20 rounded-t-2xl text-[#1976d2] text-lg shadow-inner fixed bottom-0 left-0 w-full border-t border-[#bbdefb] rodape"
        style={{
          background: "linear-gradient(120deg, #e3f0fb 0%, #fff1f2 50%, #ffd6d6 100%)",
          backdropFilter: "blur(8px)",
        }}
